...
| Client Secret | `r8lu2i1jjccjdqi1n4jpi7o74pvpfmbrcuq9vhgfdl49fet9jbi` |
| Auth Flow | `USER_PASSWORD_AUTH` (no SECRET_HASH needed) |
| OAuth Domain | `hcloud-prod.auth.eu-central-1.amazoncognito.com` |
| OAuth Client ID | `g7JEpyDnbAlcd4GctnFQ2KYf0of75XVaTmEkUCzZ` |
...
| S3 Bucket | `hcloud-storage-prod` |
| IoT Account | `616665935546` |
...
| Type | Topic ARN |
|------|-----------|
| Command | `arn:aws:iot:eu-central-1:616665935546:topic/{constructorId}/prod/cmd/{boardSerial}` |
| Event | `arn:aws:iot:eu-central-1:616665935546:topic/{constructorId}/prod/evt/{boardSerial}` |

Constructor ID for Helty: `6540c410f2bf347749e0d55c`
...
{
  "tuya": {
    "uid": "eu17545490247343ZBY8",
    "email": "...",
    "password": "5bbc9895a31b0d112778",
    "homeId": 248515349
  }
}
```
